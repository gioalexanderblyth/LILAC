    ...
    <div id="main-content" class="p-4 pt-3 min-h-screen bg-[#F8F8FF] transition-all duration-300 ease-in-out ml-64">
        ...
        <div class="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
            ...
            <div class="grid grid-cols-7 gap-2">
                ...
                <div class="h-8 flex items-center justify-center text-sm text-gray-400">15</div>
                <div class="h-8 flex items-center justify-center text-sm text-gray-400">16</div>
                <div class="h-8 flex items-center justify-center text-sm text-gray-400">17</div>
                <div class="h-8 flex items-center justify-center text-sm text-gray-400">18</div>
                <div class="h-8 flex items-center justify-center text-sm text-gray-400">19</div>
                <div class="h-8 flex items-center justify-center text-sm text-gray-400">20</div>
                <div class="h-8 flex items-center justify-center text-sm text-gray-400">21</div>
                <div class="h-8 flex items-center justify-center text-sm text-gray-400">22</div>
                <div class="h-8 flex items-center justify-center text-sm text-gray-400">23</div>
                <div class="h-8 flex items-center justify-center text-sm text-gray-400">24</div>
                <div class="h-8 flex items-center justify-center text-sm text-gray-400">25</div>
                <div class="h-8 flex items-center justify-center text-sm text-gray-400">26</div>
                <div class="h-8 flex items-center justify-center text-sm text-gray-400">27</div>
                ...
                <div class="h-8 flex items-center justify-center text-sm text-gray-400">31</div>
            </div>
        </div>
    </div>
</body>
