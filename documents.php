...
<body class="bg-[#F8F8FF]">
    ...
    <div class="fixed bottom-6 right-6 z-50">
        <button onclick="openDocumentUpload()" class="inline-flex items-center space-x-2 bg-purple-600 text-white px-6 py-3 rounded-xl text-sm font-semibold hover:bg-purple-700 hover:shadow-lg transition-all duration-300 transform hover:scale-105 shadow-2xl">
