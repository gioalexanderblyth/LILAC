...
<body class="bg-gray-50">
    ...
    <nav class="fixed top-0 left-0 right-0 z-[60] modern-nav p-4 h-16 flex items-center justify-between">
        ...
        <button id="desktop-menu-toggle" onclick="desktopToggleSidebar()" class="hidden md:flex items-center p-2 rounded-lg hover:bg-gray-100 transition-colors mr-2" title="Toggle sidebar">
            <svg class="w-6 h-6 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"></path>
            </svg>
        </button>
        <h1 class="text-xl font-bold">LILAC Events & Activities</h1>
